  ...
  return (
    <>
      <div className="w-full flex justify-center px-4 sm:px-6 lg:px-8">
        <section className="flex flex-col gap-5 px-4 items-center mt-10 w-full">
          ...
          <div className="flex flex-col gap-3 px-4 sm:px-6 lg:px-8  lg:mx-0 lg:max-w-[800px]">
            ...
            <p className="text-base w-full max-w-[800px]">
              ...
              andre ord ikke på foreningens ambisjoner.
            </p>
            <h2 className="text-center md:text-left font-bold">
              RUV-prisen og prisvinnere
            </h2>
            <p className="text-base w-full max-w-[800px]">
              Foreningen har opprettet RUV-prisen som skal være
            ...
            <h2 className="text-center md:text-left font-bold">Årsmøter</h2>
            <p className="text-base w-full max-w-[800px]">
              ...
              på Facebook med 500 følgere per august 2021. I tillegg mottar nå
              de fleste av våre medlemmer innkallinger og referater via e-post.
              Foreningens nøkterne pengebruk har ført til at vi har kunnet
              overføre hele 40 000 kroner til Ungdomsfondet samt kr 10 000 som
              bidrag til jubileumsboka til Raufoss Fotball, 100-årsgave (All
              Star team tegnet av Herbjørn Skogstad) samt midler til en del
              ...
              mimring om 6 store og små hendelser på Raufoss, og etter det
          ...
          <div className="flex flex-col gap-3 px-4 sm:px-6 lg:px-8  lg:mx-0 lg:max-w-[800px]">
            ...
            <p className="text-base w-full max-w-[800px]">
              ...
              formål eller treningsstipend i tilknytning til barne- og
              ungdomsidretten på Raufoss …»
              <br />
              Fondet ble tømt i 2018 og er nå avviklet.
            </p>
            <h2 className="text-center md:text-left font-bold">
            ...
            <p className="text-base w-full max-w-[800px]">
              ...
              tida for å kjøpe eller leie kostbare spillere er nok over
              Egenutvikling og rekruttering av yngre spillere blir derfor en
              viktig faktor for mindre klubber som vil henge med i toppfotballen
              (2. divisjon eller høyere), og en slik strategi vil også skape
              identitet og lojalitet til klubben. Raufoss Fotball har et stort
              og entusiastisk støtteapparat, og så vel de frivillige som de
              aktive utviser en fantastisk dugnadsånd. Vi håper derfor at NFF
              legger forholdene til rette for klubbene og reduserer noe på
              kravene til toppfotballen slik at Raufoss fortsatt kan være liten
              blant de store. Nammo Stadion er i ferd med å bli et praktanlegg
              og sammen med den nye Storhallen har vi stor tro på framtida.
              RUV’s beskjedne bidrag utgjør neppe noen forskjell, men vi håper
              at vi også framover kan utgjøre en liten motivasjonsfaktor for vår
              kjære klubb.
            </p>

            <p className="text-base w-full max-w-[800px]">
              Etter at denne artikkelen ble skrevet, har vårt æresmedlem, Leif
              Frode Onarheim gått bort – 87 år gammel. Han døde 9. september
              2021 og vi lyser fred over hans minne.
            </p>
          </div>
        </section>
      </div>
